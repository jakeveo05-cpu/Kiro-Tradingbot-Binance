...
class BinanceSpotEmaRsiStrategy(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.use_higher_timeframe_filter:
            ...
            rsi_htf = f"rsi_{self.informative_timeframe}"
            if ema_fast_htf in dataframe.columns and ema_slow_htf in dataframe.columns and rsi_htf in dataframe.columns:
...
class BinanceSpotEmaRsiWithHTFStrategy(BinanceSpotEmaRsiStrategy):
